    ...
    <footer className="w-full bg-white text-gray-600 px-6 md:px-16 lg:px-24 xl:px-32 pt-12 mt-20 border-t border-gray-200">
      <div className="flex flex-col md:flex-row justify-between gap-12 pb-10 border-b border-gray-300">
        ...
        <div className="max-w-md">
          <img src={assets.logo} alt="Sky Craft Logo" className="h-10" />
          <p className="mt-6 text-sm leading-relaxed">
            Experience the power of AI with <strong>Sky Craft</strong>. Transform your content creation with our suite of premium AI tools. Write articles, generate images, and enhance your productivity like never before.
          </p>
        </div>
      ...
      <div className="text-center text-xs md:text-sm mt-6 pb-6 text-gray-500">
        <p>
          &copy; 2025 <a href="https://www.linkedin.com/in/souravchandjs" className="hover:text-primary">Sourav Chand</a>. All rights reserved.
        </p>
        <p className="mt-1">
          GitHub: <a href="https://github.com/sourav-chand" className="hover:text-primary">@SouravChand</a>
        </p>
      </div>
    </footer>
  );
